...

{
  ...
  "description": "Der trbo Plugin Code ist auf jeder Seite zu integrieren, um das Tracken aller wichtigen Datenpunkte entlang der Onsite Customer Journey zu ermöglichen.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "trboPluginCode",
    "displayName": "Kundenspezifischer Plugin-Code",
    "simpleValueType": true,
    "valueHint": "trbo_xxxxx_xxxxx",
    "help": "Bitte beachten Sie, dass der für Sie zu integrierende individualisierte Code bereit gestellt wird.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
...
const _protocol = getUrl('protocol');
const _trbo_plugin = data.trboPluginCode;
const _trbo_url = _protocol + "://static.trbo.com/plugin/" + encodeUriComponent(_trbo_plugin) + ".js";

injectScript(_trbo_url, data.gtmOnSuccess, data.gtmOnFailure, _trbo_url);
